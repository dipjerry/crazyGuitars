...
<head>
    ...
    <title>CoderRat - Terms and Conditions</title>
    <meta name="description" content="CoderRat Terms and Conditions">
...
<body>
        <?php require('nav.php'); ?>
        <div class="w3-container w3-padding-32 w3-margin-top w3-justified">
    <h2><strong>Terms and Conditions</strong></h2>

    <p>Welcome to Crazy Guitars!</p>

    <p>These terms and conditions outline the rules and regulations for the use of Crazy Guitars's Website, located at https://coderrat.xyz.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Crazy Guitars if you do not agree to take all of the terms and conditions stated on this page.</p>
    ...
    <p>We employ the use of cookies. By accessing Crazy Guitars, you agreed to use cookies in agreement with the Crazy Guitars's Privacy Policy. </p>
    ...
    <p>Unless otherwise stated, Crazy Guitars and/or its licensors own the intellectual property rights for all material on Crazy Guitars. All intellectual property rights are reserved. You may access this from Crazy Guitars for your own personal use subjected to restrictions
        set in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
        <li>Republish material from Crazy Guitars</li>
        <li>Sell, rent or sub-license material from Crazy Guitars</li>
        <!-- <li>Reproduce, duplicate or copy material from Crazy Guitars</li> -->
        <!-- <li>Redistribute content from Crazy Guitars</li> -->
    </ul>
    ...
    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Crazy Guitars does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not
        reflect the views and opinions of Crazy Guitars,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Crazy Guitars shall not be liable for the
    ...
    <p>Crazy Guitars reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
    ...
    <p>You hereby grant Crazy Guitars a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit
        to us from the visibility of the hyperlink compensates the absence of Crazy Guitars; and (d) the link is in the context of general resource information.</p>
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Crazy Guitars. Please include your name, your organization name, contact information as well as the
        URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</p>
    ...
    <p>No use of Crazy Guitars's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
