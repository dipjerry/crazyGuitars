...
<body>
    ...
    <p>Welcome to Coder Rat!</p>

    <p>These terms and conditions outline the rules and regulations for the use of Coder Rat's Website, located at https://coderrat.xyz.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Coder Rat if you do not agree to take all of the terms and conditions stated on this page.</p>
    ...
    <p>We employ the use of cookies. By accessing Coder Rat, you agreed to use cookies in agreement with the Coder Rat's Privacy Policy. </p>
    ...
    <p>Unless otherwise stated, Coder Rat and/or its licensors own the intellectual property rights for all material on Coder Rat. All intellectual property rights are reserved. You may access this from Coder Rat for your own personal use subjected to restrictions
        set in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
        <li>Republish material from Coder Rat</li>
        <li>Sell, rent or sub-license material from Coder Rat</li>
        <!-- <li>Reproduce, duplicate or copy material from Coder Rat</li> -->
        <!-- <li>Redistribute content from Coder Rat</li> -->
    </ul>
    ...
    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Coder Rat does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not
        reflect the views and opinions of Coder Rat,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Coder Rat shall not be liable for the
    ...
    <p>Coder Rat reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
    ...
    <p>You hereby grant Coder Rat a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit
        to us from the visibility of the hyperlink compensates the absence of Coder Rat; and (d) the link is in the context of general resource information.</p>
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Coder Rat. Please include your name, your organization name, contact information as well as the
    ...
    <p>No use of Coder Rat's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
